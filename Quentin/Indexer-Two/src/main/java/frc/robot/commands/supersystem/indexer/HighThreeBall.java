...
public class HighThreeBall extends CommandBase {
  /**
   * subsystems used.
   */
  ...
  /**
   * Creates a new HighThreeBall.
   */
  public HighThreeBall(IndexerStageOne stageOne, IndexerStageTwo stageTwo, Indexer indexer) {
  ...
  public void initialize() {
    System.out.println("initialized HighThreeBall");
  }
