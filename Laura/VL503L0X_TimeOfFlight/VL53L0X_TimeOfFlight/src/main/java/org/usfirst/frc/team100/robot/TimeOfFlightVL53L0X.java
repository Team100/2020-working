...
public class TimeOfFlightVL53L0X implements Sendable, AutoCloseable {
	...
	private static String[] VL53L0xErrors = { "VL53L0x Not Found", // 0
	...
	public void initSendable(SendableBuilder builder) {
		...
		builder.addDoubleProperty("Value", this::readDistance, null);
	}
	...
	private enum VL53L0xRegister {
		...
		SYSTEM_THRESH_HIGH((byte) 0x0C), SYSTEM_THRESH_LOW((byte) 0x0E),

		SYSTEM_SEQUENCE_CONFIG((byte) 0x01), SYSTEM_RANGE_CONFIG((byte) 0x09),
		...
		RESULT_INTERRUPT_STATUS((byte) 0x13), RESULT_RANGE_STATUS((byte) 0x14),

		RESULT_CORE_AMBIENT_WINDOW_EVENTS_RTN((byte) 0xBC), RESULT_CORE_RANGING_TOTAL_EVENTS_RTN((byte) 0xC0),
		RESULT_CORE_AMBIENT_WINDOW_EVENTS_REF((byte) 0xD0), RESULT_CORE_RANGING_TOTAL_EVENTS_REF((byte) 0xD4),
		...
		PRE_RANGE_CONFIG_MIN_SNR((byte) 0x27), PRE_RANGE_CONFIG_VALID_PHASE_LOW((byte) 0x56),
		PRE_RANGE_CONFIG_VALID_PHASE_HIGH((byte) 0x57), PRE_RANGE_MIN_COUNT_RATE_RTN_LIMIT((byte) 0x64),

		FINAL_RANGE_CONFIG_MIN_SNR((byte) 0x67), FINAL_RANGE_CONFIG_VALID_PHASE_LOW((byte) 0x47),
		FINAL_RANGE_CONFIG_VALID_PHASE_HIGH((byte) 0x48), FINAL_RANGE_CONFIG_MIN_COUNT_RATE_RTN_LIMIT((byte) 0x44),

		PRE_RANGE_CONFIG_SIGMA_THRESH_HI((byte) 0x61), PRE_RANGE_CONFIG_SIGMA_THRESH_LO((byte) 0x62),

		PRE_RANGE_CONFIG_VCSEL_PERIOD((byte) 0x50), PRE_RANGE_CONFIG_TIMEOUT_MACROP_HI((byte) 0x51),
		PRE_RANGE_CONFIG_TIMEOUT_MACROP_LO((byte) 0x52),

		SYSTEM_HISTOGRAM_BIN((byte) 0x81), HISTOGRAM_CONFIG_INITIAL_PHASE_SELECT((byte) 0x33),
		HISTOGRAM_CONFIG_READOUT_CTRL((byte) 0x55),

		FINAL_RANGE_CONFIG_VCSEL_PERIOD((byte) 0x70), FINAL_RANGE_CONFIG_TIMEOUT_MACROP_HI((byte) 0x71),
		FINAL_RANGE_CONFIG_TIMEOUT_MACROP_LO((byte) 0x72), CROSSTALK_COMPENSATION_PEAK_RATE_MCPS((byte) 0x20),

		MSRC_CONFIG_TIMEOUT_MACROP((byte) 0x46),

		SOFT_RESET_GO2_SOFT_RESET_N((byte) 0xBF), IDENTIFICATION_MODEL_ID((byte) 0xC0),
		IDENTIFICATION_REVISION_ID((byte) 0xC2),

		OSC_CALIBRATE_VAL((byte) 0xF8),

		GLOBAL_CONFIG_VCSEL_WIDTH((byte) 0x32), GLOBAL_CONFIG_SPAD_ENABLES_REF_0((byte) 0xB0),
		GLOBAL_CONFIG_SPAD_ENABLES_REF_1((byte) 0xB1), GLOBAL_CONFIG_SPAD_ENABLES_REF_2((byte) 0xB2),
		GLOBAL_CONFIG_SPAD_ENABLES_REF_3((byte) 0xB3), GLOBAL_CONFIG_SPAD_ENABLES_REF_4((byte) 0xB4),
		GLOBAL_CONFIG_SPAD_ENABLES_REF_5((byte) 0xB5),

		GLOBAL_CONFIG_REF_EN_START_SELECT((byte) 0xB6), DYNAMIC_SPAD_NUM_REQUESTED_REF_SPAD((byte) 0x4E),
		DYNAMIC_SPAD_REF_EN_START_OFFSET((byte) 0x4F), POWER_MANAGEMENT_GO1_POWER_FORCE((byte) 0x80),

		VHV_CONFIG_PAD_SCL_SDA__EXTSUP_HV((byte) 0x89),

		ALGO_PHASECAL_LIM((byte) 0x30), ALGO_PHASECAL_CONFIG_TIMEOUT((byte) 0x30);
	...
	private boolean VL53L0xInit() throws VL53L0xTimeout {
		...
		// disable SIGNAL_RATEL53L0_MSRC (bit 1) and SIGNAL_RATE_PRE_RANGE (bit 4) limit
		// checks
		...
		setRegister(VL53L0xRegister.GPIO_HV_MUX_ACTIVE_HIGH,
				getRegister(VL53L0xRegister.GPIO_HV_MUX_ACTIVE_HIGH) & ~0x10); // active low
		setRegister(VL53L0xRegister.SYSTEM_INTERRUPT_CLEAR, 0x01);
	...
	private SequenceStepTimeouts getSequenceStepTimeouts(SequenceStepEnables enables) {
		...
		timeouts.pre_range_mclks = decodeTimeout(getRegister16bit(VL53L0xRegister.PRE_RANGE_CONFIG_TIMEOUT_MACROP_HI));
		...
		timeouts.final_range_mclks = decodeTimeout(
				getRegister16bit(VL53L0xRegister.FINAL_RANGE_CONFIG_TIMEOUT_MACROP_HI));
