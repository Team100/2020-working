...
public class Do_State_4 extends CommandBase {
  ...
  /**
   * Creates a new Do_State_4.
   */
  public Do_State_4(SampleStateMachine machine, SubsystemA subsysA, SubsystemB subsysB) {
    m_machine = machine;
  ...
  public void initialize() {
    m_machine.setCurrentState(SampleStateMachine.StateEnum.STATE_4);
    m_localTimer.reset();
    m_localTimer.start();
    m_machine.setInternalButton_4(false);
  ...
  public void end(boolean interrupted) {
    m_machine.setInternalButton_4(true);
