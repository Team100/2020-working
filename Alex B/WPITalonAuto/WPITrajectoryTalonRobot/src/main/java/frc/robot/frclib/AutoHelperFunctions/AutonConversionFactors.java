...
public class AutonConversionFactors {
     ...
     * @return
     */
    public static final double convertWPILibTrajectoryUnitsToTalonSRXNativeUnits(double metersPerSecond, double wheelDiameter, boolean usingMetric, int ticksPerRevolution){
