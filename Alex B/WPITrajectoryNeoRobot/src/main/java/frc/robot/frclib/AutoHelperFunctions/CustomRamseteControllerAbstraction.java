...
public class CustomRamseteControllerAbstraction extends RamseteController{
    ...
    public ChassisSpeeds calculate(Pose2d currentPose, Pose2d poseRef, double linearVelocityRefMeters,
            double angularVelocityRefRadiansPerSecond) {
                ...
                SmartDashboard.putNumber("vX [RPM]", AutonConversionFactors.convertMpSToRPM(vRef * m_poseError.getRotation().getCos() + k * eX, Constants.DTConstants.WHEEL_DIAMETER, Constants.DTConstants.GEARING_RATIO));
