...
from messages_pb2 import PowerCells, BoundingBox
import util
    ...
    while True:
        ...
        if config["output"] == "video":
            for obj in objs:
                ...
                cv2.circle(frame, (int(obj.bbox.xmin+(obj.bbox.xmax - obj.bbox.xmin)/2), int(obj.bbox.ymin+(obj.bbox.ymax - obj.bbox.ymin)/2)), 2, (0, 0, 255), 2)
