...
public class Indexer extends SubsystemBase {
  ...
  public Indexer() {
    ...
    frontCount = 0;
    rearCount = 0;
    leftSpx = new TalonSRX(Constants.Indexer.LEFT_SPX_CANID);

    rightSpx = new TalonSRX(Constants.Indexer.RIGHT_SPX_CANID);
  ...
  public void periodic() {
    ...
    SmartDashboard.putNumber("Current Draw Can 0", PDP.getCurrent(Constants.Indexer.LEFT_SPX_CANID));
    SmartDashboard.putNumber("Current Draw Can 1", PDP.getCurrent(Constants.Indexer.RIGHT_SPX_CANID));
  }
}