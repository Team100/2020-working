...
public class RobotContainer {
    ...
    private JoystickButton forward = new JoystickButton(leftStick, Constants.OI.STAGE_ONE_FORWARD);
    private JoystickButton reverse = new JoystickButton(leftStick, Constants.OI.STAGE_ONE_REVERSE);
    private JoystickButton zero = new JoystickButton(rightStick, Constants.OI.STAGE_TWO_FORWARD);
